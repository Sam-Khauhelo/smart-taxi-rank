<?php
// admin/process/process_profile.php
session_start();
...
switch ($action) {
    case 'update_profile':
        ...
        $email = trim($_POST['email'] ?? ''); // This is the username/email
        ...
        try {
            ...
            // Update users table - username is the email
            $sql = "UPDATE users SET full_name = :full_name, username = :email, phone_number = :phone_number 
                    WHERE id = :id";
            ...
            if (isset($_POST['owner_id_number'])) {
                $owner_id_number = trim($_POST['owner_id_number'] ?? '');
                $bank_name = trim($_POST['bank_name'] ?? '');
                $account_number = trim($_POST['account_number'] ?? '');
                $branch_code = trim($_POST['branch_code'] ?? '');
                
                $sql = "UPDATE owners SET id_number = :id_number, bank_name = :bank_name,
