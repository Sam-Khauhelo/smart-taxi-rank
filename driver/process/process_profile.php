<?php
// driver/process/process_profile.php
session_start();
...
switch ($action) {
    case 'update_profile':
        ...
        $driver_id = $_POST['driver_id'] ?? $_SESSION['driver_id'];
        ...
        try {
            ...
            // Update drivers table (only non-financial fields)
    ...
    case 'upload_image':
        ...
        try {
            ...
            $filename = 'driver_' . $user_id . '_' . time() . '.' . $extension;
